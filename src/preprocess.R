...
# Clean data file name (specify global path the one below is mine)
# C:\Users\den10\OneDrive\Documents\CSE5915\Team-Arcane-CLV\Cleandata.csv

# Bad data file name
# C:\Users\den10\OneDrive\Documents\CSE5915\Team-Arcane-CLV\Rawdata.csv
