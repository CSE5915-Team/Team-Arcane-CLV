churn_plot3_server <- function(input, output, session, data) {
  churn_plot_render_3 <- renderPlotly({
    ggplotly(data %>%
               ...
               ggplot(aes(x = nght_cnt, y = churn_probabilites, color = hshold_lifestage_last)) +
